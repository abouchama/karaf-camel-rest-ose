...
set CLASSPATH=%CLASSPATH%;%KARAF_HOME%\system\org\apache\karaf\shell\org.apache.karaf.shell.console\2.4.0.redhat-621084\org.apache.karaf.shell.console-2.4.0.redhat-621084.jar
